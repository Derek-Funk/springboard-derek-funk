...
- Lastly, you can monitor the usage of the SQL Database with the Query Performance Insight dashboard. You can investigate over a custom time period which queries are the most intensive both in terms of time and resource:
